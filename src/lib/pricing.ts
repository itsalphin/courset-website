...
const BASE_PRICES: Record<string, number> = {
  ...
  'sparkle-studs-gold': 850,
  'sparkle-studs-silver': 920,
  'sparkle-drops-gold': 1100,
  'sparkle-drops-silver': 1180,
  'diamond-ball-pendant': 1250,
  'paddle-pave-gold': 1450,
  'paddle-pave-silver': 1520,
  'paddle-ball-gold': 1680,
  'paddle-ball-silver': 1780,
  'signature-ring': 2200,
